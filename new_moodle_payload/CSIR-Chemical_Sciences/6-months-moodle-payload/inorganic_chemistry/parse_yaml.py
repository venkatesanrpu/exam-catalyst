    ...
    for path_item in learning_path:
        ...
        for content_item in textbook_content:
            ...
            for section in sections:
                ...
                # Build the list item with all links
                li_content = f'{section_title} | '

                # Study Notes link
                li_content += f'<a href="#" class="notes-link" data-function="ask_agent" data-subject="{subject}" data-lesson="{topic}" data-topic="{user_topic}" data-tags="{tags}" data-agent-text="{section_title}">Study Notes</a> | '

                # Basic Level MCQ link
                li_content += f'<a href="#" class="mcq-link" data-function="mcq" data-level="basic" data-subject="{subject}" data-lesson="{topic}" data-topic="{user_topic}" data-tags="{tags}" data-agent-text="Basic MCQ: {section_title}">MCQ Basic</a> | '

                # Intermediate Level MCQ link
                li_content += f'<a href="#" class="mcq-link" data-function="mcq" data-level="intermediate" data-subject="{subject}" data-lesson="{topic}" data-topic="{user_topic}" data-tags="{tags}" data-agent-text="Intermediate MCQ: {section_title}">MCQ Intermediate</a> | '

                # Advanced Level MCQ link
                li_content += f'<a href="#" class="mcq-link" data-function="mcq" data-level="advanced" data-subject="{subject}" data-lesson="{topic}" data-topic="{user_topic}" data-tags="{tags}" data-agent-text="Advanced MCQ: {section_title}">MCQ Advanced</a>'
